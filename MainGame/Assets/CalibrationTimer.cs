...
{
    //Zum Start des Spieles aufgerufen um die Position des Avaters richtig einzunehem--> die Bewegung dann auszuf�hren
    ...
    private IEnumerator Timer()
    {
        ...
        if (a.Length>0)
        {
            ...
            aktivPlayerModus = true; // Setze die Variable f�r das Spawnen auf true
        }
        else
        {
